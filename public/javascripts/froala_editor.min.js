...
! function(a) {
    ...
    b.initializers = [], b.count = 0, b.VALID_NODES = ["P", "DIV", "LI", "TD", "TH", "UI-VIEW"], b.LANGS = [], b.DEFAULTS = {
        ...
        this.initEvents(), this.browserFixes(), this.editableDisabled || (this.initUndoRedo(), this.enableTyping(), this.initShortcuts()), this.initTabs(), this.initEditor(), this.isLink || this.initDrag();
        for (var b = 0; b < a.Editable.initializers.length; b++) a.Editable.initializers[b].call(this);
        this.initOptions(), this.initEditorSelection(), this.initAjaxSaver(), this.setLanguage(), this.setCustomText(), this.editableDisabled || this.registerPaste(), this.initialized = !0, this.triggerEvent("initialized", [], !1, !1)
    }, b.prototype.init = function(b) {
        this.initElement(b), this.initElementStyle(), this.options.initOnClick ? (this.editableDisabled || (this.$element.attr("contenteditable", !0), this.$element.attr("spellcheck", !1)), this.$element.bind("mousedown", a.proxy(function(a) {
        ...
        this.no_verify = !0, void 0 === c && (c = !0), b = this.clean(b, !0, !1), b = b.replace(/>\s+</g, "><"), this.$element.html(b), this.$element.find("pre").each(function(b, c) {
            var d = a(c),
                e = a(c).html();
            e.indexOf("\n") >= 0 && d.html(e.replace(/\n/g, "<br>"))
        }), this.imageList = [], this.refreshImageList(), this.options.paragraphy && this.wrapText(!0), c && (this.restoreSelectionByMarkers(), this.sync()), this.$element.find("span").attr("data-fr-verified", !0), this.no_verify = !1
        ...
        return this.$element.find(".f-img-editor > img").removeClass("fr-fin fr-fil fr-fir"), this.removeFrTag(), e = this.syncCleanHTML(e, b), e = e.replace(/<a[^>]*?><\/a>/g, ""), b || (e = this.removeMarkersByRegex(e)), e = e.replace(/<span[^>]*? class\s*=\s*["']?f-img-handle[^>]+><\/span>/gi, ""), e = e.replace(/^([\S\s]*)<span[^>]*? class\s*=\s*["']?f-img-editor[^>]+>([\S\s]*)<\/span>([\S\s]*)$/gi, "$1$2$3"), e = e.replace(/^([\S\s]*)<span[^>]*? class\s*=\s*["']?f-img-wrap[^>]+>([\S\s]*)<\/span>([\S\s]*)$/gi, "$1$2$3"), e = e.replace(/\&amp;/gi, "&"), this.options.simpleAmpersand && (e = e.replace(/\&amp;/gi, "&")), d && (e = e.replace(/ data-fr-verified="true"/gi, "")), this.options.beautifyCode && (e = e.replace(/\n/gi, "")), e = e.replace(/\u200B/gi, "")
        ...
        if (!this.isHTML) {
            ...
            if ("" === this.text() && c && (0 === c.startOffset || c.startContainer === this.$element.get(0) || !this.inEditor(c.startContainer))) {
                ...
                if (c.startOffset > 0 && this.valid_nodes.indexOf(this.getSelectionElement().tagName) >= 0 || 3 === c.startContainer.nodeType) return !1;
    ...
    }, b.prototype.setFocusAtEnd = function() {
        var b = this.$element.find(this.valid_nodes.join(", "));
        0 === b.length && b.push(this.$element.get(0));
        var c = b[b.length - 1];
        a(c).append('<span class="f-marker" data-type="false" data-id="0" data-fr-verified="true"></span><span class="f-marker" data-type="true" data-id="0" data-fr-verified="true"></span>'), this.restoreSelectionByMarkers()
    }, b.prototype.breakHTML = function(b) {
        this.removeMarkers(), this.insertSimpleHTML("<break></break>");
        ...
        if (this.emptyElement(a(c))) return a(c).replaceWith(b), this.checkPlaceholder(), !0;
        ...
        if (this.no_verify = !0, window.getSelection) {
            if (b = window.getSelection(), b.getRangeAt && b.rangeCount) {
                ...
                c.insertNode(g), f && (c = c.cloneRange(), c.collapse(!1), b.removeAllRanges(), b.addRange(c))
            }
        } else if ((b = document.selection) && "Control" != b.type) {
            var h = b.createRange();
            h.collapse(!0), b.createRange().pasteHTML(a), selectPastedContent && (c = b.createRange(), c.setEndPoint("StartToStart", h), c.select())
        }
        this.no_verify = !1
    ...
    }, b.prototype.refreshPlaceholderPosition = function() {
        this.$placeholder.css("top", this.$editor.outerHeight() + 10 + parseFloat(this.$editor.css("border-top-width"), 10) + parseFloat(this.$editor.css("border-bottom-width"), 10))
    }, b.prototype.setPlaceholder = function(b) {
        b && (this.options.placeholder = b), this.$textarea && this.$textarea.attr("placeholder", this.options.placeholder), this.$placeholder || (this.$placeholder = a('<span class="fr-placeholder"></span>').bind("click", a.proxy(function() {
            this.focus()
        }, this)), this.$element.after(this.$placeholder), this.refreshPlaceholderPosition(), this.options.inlineMode || this.options.toolbarFixed || a(window).on("load resize", a.proxy(function() {
            setTimeout(a.proxy(function() {
                this.refreshPlaceholderPosition()
            }, this), 10)
        }, this))), this.$placeholder.text(this.options.placeholder)
    }, b.prototype.isEmpty = function() {
        var b = this.$element.text().replace(/(\r\n|\n|\r|\t|\u0020)/gm, "");
        return "" === b && 0 === this.$element.find("img, table, iframe, input").length && 0 === this.$element.find("p > br, div > br").length && 0 === this.$element.find(a.map(this.valid_nodes, function(a) {
        ...
        if (this.$element.find("td:empty, th:empty").append("</br>"), this.browser.msie || this.$element.find(this.valid_nodes.join(":empty, ") + ":empty").remove(), !this.isHTML)
        ...
        if (/^https?:\/\//.test(a)) {
            ...
            if (!b.test(a)) return ""
        } else a = encodeURIComponent(a).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/mailto%3A/g, "mailto:").replace(/tel%3A/g, "tel:").replace(/data%3Aimage/g, "data:image").replace(/webkit-fake-url%3A/g, "webkit-fake-url:").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/%2C/g, ",").replace(/%3B/g, ";").replace(/%2B/g, "+").replace(/%40/g, "@");
        return a
...
function(a) {
    a.Editable.commands = {
        ...
        var a;
        this.isHTML ? (this.isHTML = !1, a = this.$html_area.val(), a = this.clean(a, !0, !1), this.$box.removeClass("f-html"), this.$html_area.blur(), this.no_verify = !0, this.$element.html(a), this.cleanify(!1), this.no_verify = !1, this.$element.attr("contenteditable", !0), this.$editor.find('.fr-bttn:not([data-cmd="html"]), .fr-trigger').removeAttr("disabled"), this.$editor.find('.fr-bttn[data-cmd="html"]').removeClass("active"), this.options.paragraphy && this.wrapText(), this.$element.blur(), this.focus(), this.refreshButtons(), this.triggerEvent("htmlHide", [a], !0, !0)) : (this.$box.removeClass("f-placeholder"), this.cleanify(!1), a = this.options.inlineMode ? "\n\n" + this.cleanTags(this.getHTML(!1, !1)) : this.cleanTags(this.getHTML(!1, !1)), a = a.replace(/\&amp;/g, "&"), this.$html_area.val(a).trigger("resize"), this.$html_area.css("height", this.$element.height() - 1), this.$element.html("").append(this.$html_area).removeAttr("contenteditable"), this.$box.addClass("f-html"), this.$editor.find('button.fr-bttn:not([data-cmd="html"]), button.fr-trigger').attr("disabled", !0), this.$editor.find('.fr-bttn[data-cmd="html"]').addClass("active"), this.hide(), this.imageMode = !1, this.isHTML = !0, this.$element.blur(), this.$element.removeAttr("contenteditable"), this.triggerEvent("htmlShow", [a], !0, !1))
...
function(a) {
    a.Editable.prototype.text = function() {
        ...
        if (void 0 === b && (b = !0), !this.selectionDisabled) {
            ...
            !b && this.getRange().collapsed && a(c[0]).attr("data-collapsed") || (this.clearSelection(), b = !0);
...
function(a) {
    a.Editable.image_commands = {
        ...
        this.addListener("hidePopups", this.hideImageEditorPopup), this.options.imageTitle && a('<div class="f-popup-line f-image-alt">').append('<label><span data-text="true">Title</span>: </label>').append(a('<input type="text">').on("mouseup keydown", function(a) {
            var b = a.which;
            b && 27 === b || a.stopPropagation()
        })).append('<button class="f-ok" data-text="true" data-callback="setImageAlt" data-cmd="setImageAlt" title="OK">OK</button>').appendTo(this.$image_editor), this.$popup_editor.append(this.$image_editor), this.bindCommandEvents(this.$image_editor)
        ...
        b.$image_wrapper.on("dragover", "#f-upload-div-" + this._id, function() {
            ...
            if (b.closeImageMode(), b.hide(), b.imageMode = !1, !b.options.imageUpload || 0 !== b.$element.find(".fr-image-move").length) {
                if (b.$element.find(".fr-image-move").length > 0 && b.options.imageMove) {
                    ...
                    b.insertHTML(b.options.paragraphy ? "<p>" + d + "<p>" : d), b.$element.find(".fr-image-move").remove(), b.clearSelection(), setTimeout(function() {
        ...
        }), this.enable(), this.hide(), this.hideImageLoader(), this.wrapText(), setTimeout(a.proxy(function() {
            this.$element.find("img.fr-just-inserted").removeClass("fr-just-inserted").trigger("touchend")
        }, this), 50), this.triggerEvent("imageInserted", [b])
...
function(a) {
    a.Editable.prototype.showLinkWrapper = function() {
        ...
        if (a += "</div>", Object.keys(this.options.linkClasses).length) {
            a += '<div class="f-popup-line"><input type="text" placeholder="Choose link type" class="f-bi" id="f-luc-' + this._id + '" disabled="disabled"/>', a += '<button class="f-browse-links" id="f-links-class-' + this._id + '"><i class="fa fa-chevron-down"></i></button>', a += '<ul id="f-link-class-list-' + this._id + '">';
...
function(a) {
    ...
    a.Editable.TAG_ORDER = ["main", "section", "header", "footer", "article", "details", "legend", "summary", "table", "thead", "tbody", "tfoot", "tr", "th", "td", "ul", "ol", "li", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote", "p", "div", "a", "strong", "em", "strike", "u", "span", "iframe", "object", "param", "video", "source", "embed"], a.Editable.END_AT_SAME_INDEX = ["table", "thead", "tbody", "tfoot", "tr", "th", "td", "a", "span", "iframe", "div", "object", "param", "embed", "video", "source"], a.Editable.prototype.isClosingTag = function(a) {
        return a ? null !== a.match(/^<\/([a-zA-Z0-9]+)([^<]+)*>$/gi) : !1
    }, a.Editable.prototype.tagName = function(a) {
        return a.replace(/^<\/?([a-zA-Z0-9-!]+)([^<]+)*>$/gi, "$1").toLowerCase()
    }, a.Editable.SELF_CLOSING_TAGS = ["br", "button", "input", "img", "hr", "param", "!--", "source", "embed"], a.Editable.SELF_CLOSING_AFTER = ["source"], a.Editable.prototype.isSelfClosingTag = function(b) {
        ...
        for (var o = 0; o < b.length; o++)
            if (d = b.charAt(o), "<" == d) {
                ...
                if (-1 !== p) {
                    ...
                    } else this.valid_nodes.indexOf(g.toUpperCase()) >= 0 && (r ? r.push('data-fr-idx="' + o + '"') : r = ['data-fr-idx="' + o + '"']), j.push({
                        type: g,
                        attrs: r,
                        style: t,
                        start: h,
        ...
        if (d[0] != this.$element.get(0))
            for (var g = 0; g < d.length; g++) {
                var h = a(d[g]);
                e = h.html(), f = this.cleanOutput(e, c), f !== e && h.html(f)
