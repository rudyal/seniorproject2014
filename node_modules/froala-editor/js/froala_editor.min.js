...
! function(a) {
    ...
    b.initializers = [], b.count = 0, b.VALID_NODES = ["P", "DIV", "LI", "TD", "TH"], b.LANGS = [], b.DEFAULTS = {
        ...
        a(c).replaceWith(k.join("")), this.restoreSelectionByMarkers()
        ...
        for (var d = a("<div>").append(b).find("*"), e = 0; e < d.length; e++)
            if (this.valid_nodes.indexOf(d[e].tagName) >= 0) return this.breakHTML(b), this.cleanupLists(), !1;
...
function(a) {
    a.Editable.prototype.refreshButtons = function(b) {
        ...
        for (var c = 0; c < this.options.buttons.length; c++) {
            ...
            if (void 0 !== a.Editable.commands[d]) {
                var e = !1;
                a.isFunction(a.Editable.commands[d].disabled) ? e = a.Editable.commands[d].disabled.apply(this) : void 0 !== a.Editable.commands[d].disabled && (e = !0), e ? this.$editor.find('button[data-name="' + d + '"]').prop("disabled", !0) : this.$editor.find('button[data-name="' + d + '"]').removeAttr("disabled")
            }
        }
...
function(a) {
    a.Editable.prototype.browserFixes = function() {
        ...
        this.$element.on("keydown", a.proxy(function(a) {
            var b = a.which;
            8 == b && this.$element.hasClass("f-placeholder") && a.preventDefault()
        }, this))
